...
namespace Carcass
{
    ...
    public class VarSetStatement : Statement
    {
        public string ident;
        public object val;

        public VarSetStatement(string id, object v)
        {
            ident = id;
            val = v;
            kind = StatementKind.SetVar;
        }
    }
    ...
    public class WhileStatement : Statement
    {
        ...
        public WhileStatement(Expression ex, BlockStatement stmtt)
        {
            expr = ex;
            stmt = stmtt;
...

    {
        ...
        [Rule("stmt: Identifier Equal expression")]
        private static Statement SetVar(Token ident, Token Eq, Expression expr)
        {
        ...
        [Rule("stmt: KwWhile expression block_stmt")]
        private static Statement WhileStmt(Token kw, Expression expr, BlockStatement stmts)
        {
